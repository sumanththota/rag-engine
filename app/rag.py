...
_PROMPT_TEMPLATE = 'Context (retrieved from handbook):\n\t%s\n\t\n\t---\n\t\n\tQuestion: %s\n\t\n\tThink through the following before responding:\n\t1. Is this a casual or conversational question that doesn\'t require handbook knowledge?\n\t2. Does the context contain a clear answer to the question?\n\t3. Use normal English spacing between words (never merge words, e.g. write "must satisfy" not "mustsatisfy").\n\t\n\tThen respond using this format:\n\t\n\t[Your response here, in plain prose. Never include page numbers, section numbers, or any other citation in your response, even if one appears in the context above — the context is for your reference only, not for quoting back.]\n\t'
