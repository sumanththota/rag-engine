...
state: "agent:in-progress"   # 2026-09-20T17:45Z: verifier round 1 NEEDS_WORK (criterion 3 test hollow, PR #29 comment). Fix-round implementer dispatched, scoped to tests/test_login_ui.py only.
